...
Uruchom po uzupełnieniu plików _INF.txt i wrzuceniu plików do podfolderów.
"""
...
# ── Kolory i styl (identyczne jak w Setup) ─────────────────────────────────────
BG          = "#1a1a1a"
BG_CARD     = "#242424"
BG_INPUT    = "#2e2e2e"
ACCENT      = "#00c896"
ACCENT_DIM  = "#008f6a"
ACCENT2     = "#5b8cff"       # niebieski dla kroku 2
ACCENT2_DIM = "#3a6bdd"
TEXT        = "#f0f0f0"
TEXT_DIM    = "#888888"
TEXT_LOG    = "#d4d4d4"
...
def iter_projects(root: Path, meta: dict):
    for level1 in sorted(root.iterdir()):
        ...
        for level2 in sorted(level1.iterdir()):
            ...
            project_name = rest if rest else workshop_code
            yield cat_label, workshop_code, level2, project_name


def process_large_archive(root: Path, meta: dict, log) -> None:
    log("━━━  DUŻE ARCHIWUM  ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
...
def create_small_archive(root: Path, meta: dict, log) -> None:
...
def run_archive(root: Path, log) -> None:
...
class ArchiveApp(tk.Tk):
    ...
    def _build_ui(self):
        ...
        checks = [
            ...
            "✓  Pliki są w odpowiednich podfolderach (zdjecia / plansze / film itp.)",
            "✓  Folder główny NIE ma na końcu  _E",
            "✓  Pillow jest zainstalowane:  pip install Pillow",
        ]
        for c in checks:
            color = ACCENT if c.startswith("✓") else TEXT_DIM
